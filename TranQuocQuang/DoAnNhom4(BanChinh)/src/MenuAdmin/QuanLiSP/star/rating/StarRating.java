package MenuAdmin.QuanLiSP.star.rating;
...
private ArrayList<EventStarRating> events = new ArrayList<>();
    private int star;
    public StarRating() {
        initComponents();
        init();
    ...
    private void initComponents() {
        ...
        star1 = new MenuAdmin.QuanLiSP.star.rating.Star();
        star2 = new MenuAdmin.QuanLiSP.star.rating.Star();
        star3 = new MenuAdmin.QuanLiSP.star.rating.Star();
        star4 = new MenuAdmin.QuanLiSP.star.rating.Star();
        star5 = new MenuAdmin.QuanLiSP.star.rating.Star();
...
public void setForeground (Color color) {
    ...
    public void addEventStarRting(EventStarRating event){
        event.add(event);
    }
    ...
    private MenuAdmin.QuanLiSP.star.rating.Star star1;
    private MenuAdmin.QuanLiSP.star.rating.Star star2;
    private MenuAdmin.QuanLiSP.star.rating.Star star3;
    private MenuAdmin.QuanLiSP.star.rating.Star star4;
    private MenuAdmin.QuanLiSP.star.rating.Star star5;
