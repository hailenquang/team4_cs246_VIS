...
public class Form_Doanh_Thu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        chart.addData(new ModelChart("June", new double[]{190, 280, 700, 300}));
        chart.addData(new ModelChart("July", new double[]{400, 500, 400, 600}));
        chart.addData(new ModelChart("August", new double[]{600, 400, 800, 400}));
        chart.addData(new ModelChart("September", new double[]{800, 500, 500, 800}));
        chart.addData(new ModelChart("October", new double[]{500, 500, 700, 500}));
        chart.addData(new ModelChart("November", new double[]{700, 400, 300, 600}));
        chart.addData(new ModelChart("December", new double[]{500, 600, 800, 1000}));
