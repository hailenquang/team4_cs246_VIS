...
public class Calculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtResult, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        btnSquareRoot.setBackground(new java.awt.Color(204, 204, 204));
        ...
        btnFraction.setBackground(new java.awt.Color(204, 204, 204));
    ...
    private void btnEqualsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEqualsActionPerformed
        ...
        try {
            double oprant1 = Double.parseDouble(operand1);
            double oprant2 = Double.parseDouble(txtResult.getText());
            double result = 0;
            if (operator.equals("+")) {
                result = oprant1 + oprant2;
