...
public class ThemXoaSP extends javax.swing.JInternalFrame {
    ...
    public ThemXoaSP() {
        ...
        list.add(new Danhsach("Iphone 14","IOS","Chup anh,quay phim","1TB","Sac sieu nhanh","Khang bui nuoc","12G", 19000000, " "));
        list.add(new Danhsach("Samsung Galaxy S24","Adroid","Choi game","1TB","Sac sieu nhanh","Khang bui nuoc","12G", 44490000, " "));
        list.add(new Danhsach("Nokia 8210","Dien thoai pho thong","Pin khung","32G","Sac sieu nhanh"," "," ", 1590000, " "));
        list.add(new Danhsach("Irealme 11 Pro+","Adroid","Chup anh,quay phim va choi game","512GB","Sac sieu nhanh","Khang bui nuoc","12G", 14990000, " "));
        View();
        ViewTable();
    }
     public void View(){
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(check == 1)
        {
            list.add(new Danhsach(hang,dt,nc,dl,tn,tndb,ram, gia, " "));
        }
        if(check == -1)
        {
            list.set(pos ,new Danhsach(hang,dt,nc,dl,tn,tndb,ram, gia, " "));
        }
        list.add(new Danhsach(hang,dt,nc,dl,tn,tndb,ram, gia, " "));
        View();
        ViewTable();
